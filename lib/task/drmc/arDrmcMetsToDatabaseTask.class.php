 ...
 * @subpackage  drmc
 */
class arDrmcMetsToDatabaseTask extends sfBaseTask
{
...
The [drmc:mets2db|INFO] task parses and adds to the database the metadata from the METS files copied to the uploads folder in DIP uploads.
EOF;
  }
