...
abstract class BasePremisObject extends QubitObject implements ArrayAccess
{
  const
    ...
    CREATED_AT = 'premis_object.CREATED_AT',
    UPDATED_AT = 'premis_object.UPDATED_AT';
  ...
  public static function addSelectColumns(Criteria $criteria)
  {
    ...
    $criteria->addSelectColumn(QubitPremisObject::CREATED_AT);
    $criteria->addSelectColumn(QubitPremisObject::UPDATED_AT);
